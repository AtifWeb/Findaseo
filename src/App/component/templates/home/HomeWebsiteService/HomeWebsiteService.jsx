      ...
      <div className={`w-1200 ${styles.content}`}>
        <div className={styles.Grid}>
          <div>
            <h1 className={styles.MainHeading}>
              Convert More Website Visitors <br /> into Paying Customers <br />{" "}
              in Record Time
            </h1>
        ...
        <div className={styles.CardsWrapper}>
          <HomeCard
            ...
            largeImg="./images/Business Messenger.jpg"
          />
          <HomeCard
            bgcolor="#fff"
            ...
            largeImg="./images/Stay Organized.png"
          />
          <HomeCard
            bgcolor="#fff"
            ...
            largeImg="./images/convert_business.jpg"
          />
          {/* <HomeCard
            LargeText="R"
            bgcolor="#13225F"
